...
public class maxDivisor {
    public static void main(String KGB[]){
        ...
        System.out.println("Integer with most divisor using multiple threads : " +num);
        ...
        th11 o11 = new th11();
        o11.start();
        try{o11.join();}catch (Exception e){}
        int arr011[] = o11.fnc();
        if(arr011[0] > maxValue){maxValue = arr011[0]; num = arr011[1];}
        
        System.out.println("Integer with most divisor using single threads : " +num);
        System.out.println("Total divisor is : " +maxValue);
        System.currentTimeMillis();
        System.out.println(System.currentTimeMillis());
